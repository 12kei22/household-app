                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('tasks.store', $currentProjectId) }}">
                            ...
                            <div class="form-group d-flex flex-column flex-md-row">
                                ...
                                <div class="col-md-6">
                                    <input id="spending_name" type="type" class="form-control @error('spending_name') is-invalid @enderror" name="spending_name" value="{{ old('spending_name') }}" required autocomplete="spending_name" autofocus>
                                    @error('task_name')
