  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('spendings.update', [$spending->project_id, $spending->id]) }}">
            @csrf
            ...
            <div class="form-group d-flex flex-column flex-md-row mt-3">
              ...
              <div class="col-md-6">
                <select name="spending_amount" id="spending_amount"
                  ...
                  <option @if ($key==old('spending_amount', $spending->spending_amount)) selected @endif value="{{ $key
            ...
            <div class="form-group d-flex mt-3 mb-0">
              <div class="col-md-10 col-12 d-flex justify-content-end">
                <button style="margin-right: 10px;" type="submit" class="btn btn-primary">更新</button>
                <form action="{{ route('spendings.destroy', [$currentProjectId, $spending->id]) }}" method="POST">
                  @csrf
